...
## Project Structure
    ...
    ├── restless_feather_de_79189  # Django project configurations
...
1. Clone this repo and `cd restless_feather_de_79189`
...
2. Clone this repo and `cd restless_feather_de_79189`
